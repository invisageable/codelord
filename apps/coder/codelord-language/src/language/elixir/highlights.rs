//! Elixir syntax highlighting using tree-sitter-elixir.
...
/// Parse Elixir source code and extract tokens for syntax highlighting.
...
fn map_capture_to_token(capture_name: &str) -> Option<TokenKind> {
  Some(match capture_name {
    ...
    "type" | "module" => TokenKind::IdentifierType,
    ...
    "atom" | "symbol" => TokenKind::IdentifierConstant,
    "sigil" => TokenKind::Keyword,
    _ => return None,
  })
}
